...
<body>
    ...
    <div class="bottom-nav">
        <a href="home.php" class="nav-item active"><img src="home_icon.png" style="width: 24px; height: 24px; display: block; margin: 0 auto 2px;">Beranda</a>
        <a href="order.html" class="nav-item"><img src="order_icon.png" style="width: 24px; height: 24px; display: block; margin: 0 auto 2px;">Order</a>
